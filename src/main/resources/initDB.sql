...
DROP SEQUENCE IF EXISTS books_global_sequence;
DROP TABLE IF EXISTS students;
DROP TABLE IF EXISTS books;

CREATE SEQUENCE students_global_sequence START 1000;
CREATE SEQUENCE books_global_sequence START 1000;
...
CREATE TABLE books (
  id      INTEGER PRIMARY KEY DEFAULT nextval('books_global_sequence'),
